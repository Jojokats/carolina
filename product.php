...
<div class="container mt-5">
  <div class="row no-gutters">
    <div class="col-12 hero">
      <img src="img/gel.jpg" class="img-fluid" alt="About Us"/>
...
<div class="container" id="ourservices">
  <div class="row">
    ...
    <main class="col-lg-8 main-content mt-5">
        ...
        <p>
          Exclusive night cream sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
        </p>
